...
function SearchForm({
  ...
  return (
    <div className="p-8 bg-gray-800 rounded-lg shadow-lg w-full mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        ...
        <div>
          <label htmlFor="minKi" className="block font-medium mb-1">
            Min Ki
          </label>
          <div className="flex gap-2">
            ...
            <select
              ...
              className="w-1/3 px-4 py-2 rounded-md border border-gray-300 bg-gray-800 focus:outline-none "
            >
        ...
        <div>
          <label htmlFor="maxKi" className="block font-medium mb-1">
            Max Ki
          </label>
          <div className="flex gap-2">
            <input
            ...
            <select
              ...
              className="w-1/3 px-4 py-2 rounded-md border border-gray-300 bg-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
              {kiUnitOptions.map(option => (
